...
const {getUsers , deleteUser , getUserById, addScouter, getScouter , activateScouter, desactivateScouter} = require('../controllers/adminController');
const {protect,role} = require('../../middlewares/authMiddlewre');

router.route('/getUsers').get(protect,role('admin'),getUsers);
